...
# Check hashes of downloaded source archives. Current versions use sha-256,
# older versions fall back to sha-1. On gnu systems sha256sum/sha1sum are used.

# HASH_CMD = sha256sum -c
# HASH_CMD = shasum -a 256 -c

# SHA1_CMD is only needed when building older versions that lack .sha256 hashes.
# SHA1_CMD = sha1sum -c
